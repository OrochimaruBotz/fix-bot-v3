...
global.sig = 'https://instagram.com/humanzboti' // ig
...
/*============== STAFF ==============*/
global.owner = [
  ['6288804947282', 'WH MODS DEV', true],
  ['62888049472823', 'Costumer Service', true],
...
/*============== WATERMARK ==============*/
global.wm = '                「 Humanz Botz-MD 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰HUMANZBOTZ ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ HUMANZBOTZMD '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Humanz`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 HumanzBotzMD  あ」'
